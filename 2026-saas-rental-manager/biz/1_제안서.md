...
|:---|:---|:---|
| 연체 위험 스코어링 → 사전 독촉 | 미납 1건을 **30일 늦게**가 아니라 **납기 전~D+1**에 인지 → 회수율 체감 개선(연체는 시간 경과로 회수난이도 급등). 미납 1건 50만원 기준, 한 해 1~2건의 장기 미납을 막으면 **연 50만~100만원 손실 방지** | 엑셀·기억은 "이미 밀린 뒤" 발견. 사전 신호 자체가 불가능 |
