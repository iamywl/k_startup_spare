...
- **공식값**: 한국 SaaS 시장(IDC, [^1]), 중소기업 수 804만(중기부, [^6]), 도입률 24.9%([^18]), 경쟁사 실적·가격([^7]~[^11], [^15]~[^17]), 4대보험 요율·전자세금계산서 기준([^12][^14])은 검증된 공식·1차/언론 출처값이다.
